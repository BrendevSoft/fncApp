...
public class GroupeUtilisateur extends BaseEntity {
    ...
    @EmbeddedId
    protected GroupeUtilisateurId id;
    ...
    public String toString() {
        return "GroupeUtilisateur{" + "id=" + id + ", dateRevocation=" + dateRevocation + ", dateAffectation=" + dateAffectation + ", datecreation=" + datecreation + ", rowvers=" + rowvers + ", utilisateurLogin=" + utilisateurLogin + ", groupe=" + groupe + ", utilisateur=" + utilisateur + '}';
    }
