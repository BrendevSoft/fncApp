 ...
 */
package com.fncapp.fncapp.web.template.component.menu;
...
@ListenerFor(sourceClass = FncAppMenu.class, systemEventClass = PostAddToViewEvent.class)
public class FncAppMenu extends AbstractMenu implements Widget,ComponentSystemEventListener {
